...
class online_checkoutValid extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['required','min:2', 'max:30'], // Chỉ cho phép ký tự chữ và khoảng trắng
            'email' => 'required|email|ends_with:@gmail.com',
            'dien_thoai' => 'required|min:10', // Chỉ cho phép ký tự số
            'dia_chi' => 'required', // Cho phép chữ cái, số, khoảng trắng, dấu phẩy, dấu chấm, dấu gạch ngang
            ];
    }
