...
@section('title') Danh sách đơn hàng đã hủy  @endsection
...
<table class="table table-bordered m-auto" id="dsdonhang">
    <div style="margin-left: 0px; margin-right: 0px" class="row bg-gradient-dark text-white fw-bolder">
        <div class="col-6">
            <label class="mt-2 mb-2">DANH SÁCH ĐƠN HÀNG ĐÃ HỦY</label>
        </div>
        ...
        <tbody>
            @foreach ($donhang as $dh)
                <tr>
                    ...
                    <td class="text-center"><a class="btn btn-primary btn-sm" href="{{ route('donhang.chitiet', $dh->id) }}">Chi tiết sản phẩm</a></td>
