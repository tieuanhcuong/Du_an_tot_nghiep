...
<head>
  ...
  <title>Thông Báo Phục Hồi Đơn Hàng</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <div class="content">
        <p>Chúng tôi xin thông báo rằng đơn hàng của bạn với mã đơn hàng <strong>#{{ $donHang->id }}</strong> đã được phục hồi lại thành công theo yêu cầu của bạn.</p>
        ...
        <p>Chúng tôi sẽ xem và xác nhận đơn hàng sớm nhất có thể.</p>
